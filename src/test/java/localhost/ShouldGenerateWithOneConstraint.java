...
public class ShouldGenerateWithOneConstraint {
    ...
    public static void executeAfterTest() {
        assertEquals(2, fActualCallCounter);
    }

    @EcFeedTest
    @EcFeedInput("'dataSource':'genCartesian','constraints':['c1'], 'method':'test.Class1.testMethod'")
